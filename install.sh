...
NZ_DASHBOARD_PATH="${NZ_BASE_PATH}/dashboardv0"
NZ_AGENT_PATH="${NZ_BASE_PATH}/agent"
NZ_DASHBOARD_SERVICE="/etc/systemd/system/nezha-dashboard-v0.service"
NZ_DASHBOARD_SERVICERC="/etc/init.d/nezha-dashboard-v0"
